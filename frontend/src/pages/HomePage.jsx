                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="hidden lg:flex items-center space-x-8">
                            <Link to="/products" className="text-gray-700 hover:text-red-600 font-medium transition-colors">Catalog</Link>
                            <Link to="/about" className="text-gray-700 hover:text-red-600 font-medium transition-colors">About</Link>
                            <Link to="/testimonials" className="text-gray-700 hover:text-red-600 font-medium transition-colors">Testimonials</Link>
                            <Link to="/inquiry" className="text-gray-700 hover:text-red-600 font-medium transition-colors">B2B Inquiry</Link>
                        </div>
                    ...
                    {isMobileMenuOpen && (
                        <div className="lg:hidden border-t border-gray-200 py-4 bg-white rounded-b-xl">
                            <div className="flex flex-col space-y-4">
                                <Link to="/products" className="text-gray-700 hover:text-red-600 font-medium px-2 py-1 rounded-lg hover:bg-gray-50">Catalog</Link>
                                <Link to="/about" className="text-gray-700 hover:text-red-600 font-medium px-2 py-1 rounded-lg hover:bg-gray-50">About</Link>
                                <Link to="/testimonials" className="text-gray-700 hover:text-red-600 font-medium px-2 py-1 rounded-lg hover:bg-gray-50">Testimonials</Link>
                                <Link to="/inquiry" className="text-gray-700 hover:text-red-600 font-medium px-2 py-1 rounded-lg hover:bg-gray-50">B2B Inquiry</Link>
                            </div>
                        </div>
                    )}
                </div>
